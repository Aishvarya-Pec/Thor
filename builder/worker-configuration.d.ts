/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b0ae88bdaf3e105561be1916944a8439)
// Runtime types generated with workerd@1.20250924.0 2024-09-23 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		CLERK_PUBLISHABLE_KEY: string;
		CLERK_SECRET_KEY: string;
		OPEN_ROUTER_API_BASE_URL: string;
		OPEN_ROUTER_API_KEY: string;
		OPEN_ROUTER_API_KEY_OLD: string;
		OPEN_ROUTER_API_KEY_2: string;
		OPEN_ROUTER_API_KEY_3: string;
		OPEN_ROUTER_API_KEY_4: string;
