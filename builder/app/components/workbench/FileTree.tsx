  ...
  return (
    <NodeButton
      className={classNames('group', {
        'bg-transparent text-thor-elements-item-contentDefault hover:text-thor-elements-item-contentActive hover:bg-thor-elements-item-backgroundActive':
          !selected,
        'bg-thor-elements-item-backgroundAccent text-thor-elements-item-contentAccent': selected,
      })}
      depth={depth}
...
function File({ file: { depth, name }, onClick, selected, unsavedChanges = false }: FileProps) {
  return (
    <NodeButton
      className={classNames('group', {
        'bg-transparent hover:bg-thor-elements-item-backgroundActive text-thor-elements-item-contentDefault': !selected,
        'bg-thor-elements-item-backgroundAccent text-thor-elements-item-contentAccent': selected,
      })}
      depth={depth}
      iconClasses={classNames('i-ph:file-duotone scale-98', {
        'group-hover:text-thor-elements-item-contentActive': !selected,
      })}
      onClick={onClick}
    >
      <div
